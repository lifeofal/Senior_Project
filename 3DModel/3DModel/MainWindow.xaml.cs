...
namespace _3DModel
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            var model = read.Read(MODEL_PATH);
            ...
            {
                Console.WriteLine("3D Point: " + _3dPoints[i].X + " " + _3dPoints[i].Y + " " + _3dPoints[i].Z);
                Console.WriteLine("Triangle Index: "+ triangleIndex[i]);
                Console.WriteLine("Texture Coordinate: " +textureCoordinates[i].X + " " + textureCoordinates[i].Y);
                Console.WriteLine("Normal Vector: " + normVectors[i].X + " " + normVectors[i].Y + " " + normVectors[i].Z);
            }
