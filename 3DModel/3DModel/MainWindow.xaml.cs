...
namespace _3DModel
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            Point3D[] array = mesh.Positions.ToArray();
            int[] array2 = mesh.TriangleIndices.ToArray();
            Point[] array3 = mesh.TextureCoordinates.ToArray();
            Vector3D[] array4 = mesh.Normals.ToArray();
            Console.WriteLine(array3.Length);
            for(int i = 0; i < array.Length; i++)
            {
                Console.WriteLine(array4[i].X + " " + array4[i].Y+" "+array[4].Z);
            }
