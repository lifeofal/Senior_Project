...
namespace _3DModel
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private Boolean isInBounds(Transform3DGroup trans)
        {
            ...
            if((xMin >= 0) && (xMax <= 200) && (yMin >= 0) && (yMax <= 200))
            {
                return true;
            }
            Console.WriteLine("Invalid transformation - out of bounds. Try moving object away from the edges.");
            return false;
        }
